...
module.exports = {
    ...
    editFile: function (req, res, msg) {
        ...
        var content = '';
        try {
            content = fs.readFileSync(req.params.contentType + category + '/' + req.params.file).toString();
        } catch (e) {
            console.log('no file for read',  req.params.contentType + category + '/' + req.params.file);
        }
        ...
        _.forEach(
            ...
            function (theme) {
                ...
                if (themeSplit[0] == themeName) {
                    isDefault = ' selected ';
                } else {
                    isDefault = '';
                }
                themeHTML += '<option name="' + themeSplit[0] + '"' + isDefault + 'value="' + themeSplit[0] + '">' +
                                (themeSplit[1] || themeSplit[0]) +
                            '</option>';
            }
        );
        themeHTML += '</select>';
