...
module.exports = {
    ...
    backupList: function (req, res) {
        ...
        var resHTML =
            '<p><a href="/' + SiteOptions.adminDir + '/logout">Exit</a></p>';
            '<p><a href="/' + SiteOptions.adminDir + '/backups">Create</a></p>'
        ;
        _.forEach(
            backupList,
            function (fileName) {
                resHTML += '<p><a href="/' + SiteOptions.adminDir + '/backups/' + fileName + '">' + fileName + '</a></p>';
            }
        );
